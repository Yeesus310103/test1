...
const durationButton = document.getElementById("changeDuration");
const durationText = document.getElementById("duration-text");


function changeDuration() {
    
    let newDurationInput = prompt("Enter the new duration:");
    let newDuration = parseFloat(newDurationInput);
